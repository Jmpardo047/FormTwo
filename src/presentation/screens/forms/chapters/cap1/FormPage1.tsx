        ...
        <Formik
          ...
          {({handleChange, handleBlur,handleSubmit,values, errors, touched, setFieldValue, setFieldTouched}) =>(
              <View >
                ...
                <InputComponent
                  info='P2'
                  textTitle='P2. Número de celular:'
                ...
                <InputComponent
                  info='P3'
                  textTitle='P3. Nombre departamento:'
                ...
                <InputComponent
                  info='P4'
                  textTitle='P4. Código departamento:'
